...
| `.github/workflows/scan.yml`    | PR, weekly                    | Caller for the shared scan in `uinaf/.github` as one `scan / Scan` job: gitleaks and trufflehog always, actionlint and zizmor when workflow or scanner config changes |
